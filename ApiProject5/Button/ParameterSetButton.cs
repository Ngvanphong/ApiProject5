...
// Type: ApiProject5.Button.ParameterSetButton
...
namespace ApiProject5.Button
{
  public class ParameterSetButton
  {
    public void ParameterSet(UIControlledApplication application)
    {
      ...
      ImageSource imageSource = (ImageSource) Extension.GetImageSource((Image) Resources.icons8_set_as_resume_32);
      PushButtonData pushButtonData1 = new PushButtonData("ParameterValue", "Parameter \r Value", Assembly.GetExecutingAssembly().Location, "ApiProject5.ParameterSetValue.ParameterValueBinding");
      pushButtonData1.ToolTip = "Set value for parameter";
      pushButtonData1.LongDescription = "Set value for parameter";
