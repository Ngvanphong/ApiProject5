  ...
  public  class TransferMoreButton
    {
        public void TransferMoreFuc(UIControlledApplication application)
        {
            ...
            Image img = ApiProject5.Properties.Resources.icons8_data_transfer_32;
            ImageSource imgSrc = Helper.Extension.GetImageSource(img);
            PushButtonData btnData = new PushButtonData("TransferMore", "Transfer \r More",
                Assembly.GetExecutingAssembly().Location, "ApiProject5.TransferMore.TransferMoreBinding")
            {
                ToolTip = "Transfer to other project",
                LongDescription = "Transfer to other project",
                Image = imgSrc,
                LargeImage = imgSrc,
            };
